...
# 图片Base64缓存（TTLCache 自动管理过期和大小）
IMAGE_BASE64_CACHE: TTLCache = TTLCache(maxsize=1000, ttl=3600)
IMAGE_CACHE_MAX_SIZE = 1000
IMAGE_CACHE_TTL = 3600

# 图床URL缓存（TTLCache 自动管理过期和大小）
FILEBED_URL_CACHE: TTLCache = TTLCache(maxsize=500, ttl=300)
...
# 输入图片处理缓存（TTLCache 自动管理过期和大小）
PROCESSED_IMAGE_CACHE: TTLCache = TTLCache(maxsize=200, ttl=3600)
