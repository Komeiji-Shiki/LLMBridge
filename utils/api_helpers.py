...
def format_openai_finish_chunk(model: str, request_id: str, reason: str = 'stop', usage: dict = None) -> str:
    """格式化为 OpenAI 结束块。"""
    chunk = {
        "id": request_id, "object": "chat.completion.chunk",
        "created": int(time.time()), "model": model,
...
def format_openai_non_stream_response(content: str, model: str, request_id: str, reason: str = 'stop', usage: dict = None) -> dict:
